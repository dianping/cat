...
import com.dianping.cat.problem.analyzer.ProblemReportMerger;
...
import com.dianping.cat.problem.model.entity.Segment;
...
public class LocalProblemService extends LocalModelService<ProblemReport> {
	...
	public static class ProblemReportFilter extends com.dianping.cat.problem.model.transform.DefaultXmlBuilder {
		...
		@Override
		public void visitDuration(com.dianping.cat.problem.model.entity.Duration duration) {
