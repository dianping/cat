...
public class IntegratedJDBCTestsConfigurator extends AbstractResourceConfigurator {
	public static void main(String[] args) {
		generatePlexusComponentsXmlFile(new IntegratedJDBCTestsConfigurator());
	}
	...
	protected File getConfigurationFile() {
		return new File("src/test/resources/" + IntegratedJDBCTestsConfigurator.class.getName().replace('.', '/')
		      + ".xml");
	}
}
