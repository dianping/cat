...
public class ComponentsConfigurator extends AbstractResourceConfigurator {
	...
	public List<Component> defineComponents() {
		...
		all.add(C(AggregationConfigManager.class).req(AggregationHandler.class, ConfigDao.class, ContentGetter.class));

		all.add(C(AppConfigManager.class).req(ConfigDao.class, ContentGetter.class));

		all.add(C(AppComparisonConfigManager.class).req(ConfigDao.class, ContentGetter.class));
		...
		all.add(C(UrlPatternConfigManager.class).req(ConfigDao.class, UrlPatternHandler.class, ContentGetter.class));
