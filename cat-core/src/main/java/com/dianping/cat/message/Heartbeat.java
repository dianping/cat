...
/**
 * <p>
 * <code>Heartbeat</code> is used to log data that happens in a regular
 ...
 * etc., and even some configuration could be carried by <code>Heartbeat</code>.
 * There could be some good use cases, for example health checker and load
 * balancer, that make good use of it.
 * </p>
 * 
 * <p>
 * <code>Heartbeat</code> should never be used per request since the request is
