...
import com.dianping.cat.transaction.model.entity.AllDuration;
...
public class LocalTransactionService extends LocalModelService<TransactionReport> {
	...
	public static class TransactionReportFilter extends
	      com.dianping.cat.transaction.model.transform.DefaultXmlBuilder {
		...
		@Override
		public void visitMachine(com.dianping.cat.transaction.model.entity.Machine machine) {
