...
public class LocalEventService extends LocalModelService<EventReport> {
	...
	public static class EventReportFilter extends com.dianping.cat.event.model.transform.DefaultXmlBuilder {
		...
		@Override
		public void visitMachine(com.dianping.cat.event.model.entity.Machine machine) {
		...
		@Override
		public void visitRange(com.dianping.cat.event.model.entity.Range range) {
