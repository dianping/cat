...
public class HistoryGraphs {
	...
	public LineChartItem buildHistoryGraph(String domain, Date start, Date end, String reportType, String key) {
	...
	private LineChartItem getDateFromDailyReport(String domain, Date start, Date end, String key) {
	...
	private LineChartItem getDateFromHourlyReport(String domain, Date start, Date end, String key) {
		List<HealthReport> reports = new ArrayList<HealthReport>();
