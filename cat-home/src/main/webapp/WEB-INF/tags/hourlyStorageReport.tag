...
<div class="report">
	<div class="breadcrumbs" id="breadcrumbs">
		<table>
				...
				<td><div id="warp_search_group" class="" style="width:250px;">
					<form id="wrap_search" style="margin-bottom:0px;">
						<div class="input-group">
							...
							<span class="input-group-btn "><button class="btn btn-sm btn-grey"
			...
			<td><div class="nav-search nav" style="margin-top: 6px;" id="nav-search">
			<span class="text-danger switch">【<a class="switch" href="${model.baseUri}?op=history&type=${payload.type}&domain=${model.domain}&id=${payload.id}&ip=${model.ipAddress}"><span class="text-danger">历史模式</span></a>】</span>
