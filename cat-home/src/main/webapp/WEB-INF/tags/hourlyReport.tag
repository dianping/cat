...
<div class="report">
	<div class="breadcrumbs" id="breadcrumbs">
		<table>
			...
			<span class="text-danger switch">【<a class="switch" href="${model.baseUri}?op=history&domain=${model.domain}&ip=${model.ipAddress}"><span class="text-danger">历史模式</span></a>】</span>
