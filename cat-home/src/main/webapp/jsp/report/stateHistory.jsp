...
<table class="machines">
	<tr style="text-align:left">
		<th>Machines: &nbsp;[&nbsp; <c:choose>
				...
				<c:otherwise>
					<a href="?op=history&reportType=${model.reportType}&domain=${model.domain}&date=${model.date}">All</a>
				</c:otherwise>
			</c:choose> &nbsp;]&nbsp; <c:forEach var="ip" items="${model.ips}">
   	  		&nbsp;[&nbsp;
   	  		<c:choose>
					<c:when test="${model.ipAddress eq ip}">
						<a href="?op=history&reportType=${model.reportType}&domain=${model.domain}&ip=${ip}&date=${model.date}"
							class="current">${ip}</a>
					</c:when>
					<c:otherwise>
						<a href="?op=history&reportType=${model.reportType}&domain=${model.domain}&ip=${ip}&date=${model.date}">${ip}</a>
					</c:otherwise>
				</c:choose>
   	 		&nbsp;]&nbsp;
			 </c:forEach>
...
<table width="80%">
	...
	<tr class='odd'>
		<td><a href="?op=historyGraph&reportType=${model.reportType}&date=${model.date}&key=total" data-status="total" class="graph_link">[::show::]</a></td>
		<td>处理消息总量</td>
	...
	<tr class='even'>
		<td><a href="?op=historyGraph&reportType=${model.reportType}&date=${model.date}&key=totalLoss" data-status="totalLoss" class="graph_link">[::show::]</a></td>
		<td>丢失消息总量</td>
	...
	<tr class='odd'>
		<td><a href="?op=historyGraph&reportType=${model.reportType}&date=${model.date}&key=avgTps" data-status="avgTps" class="graph_link">[::show::]</a></td>
		<td>每分钟平均处理数</td>
	...
	<tr class='even'>
		<td><a href="?op=historyGraph&reportType=${model.reportType}&date=${model.date}&key=maxTps" data-status="maxTps" class="graph_link">[::show::]</a></td>
		<td>单台机器每分钟最大处理数</td>
	...
	<tr class='odd'>
		<td><a href="?op=historyGraph&reportType=${model.reportType}&date=${model.date}&key=dump" data-status="dump" class="graph_link">[::show::]</a></td>
		<td>gzip压缩成功消息数量</td>
	...
	<tr class='even'>
		<td><a href="?op=historyGraph&reportType=${model.reportType}&date=${model.date}&key=dumpLoss" data-status="dumpLoss" class="graph_link">[::show::]</a></td>
	...
	<tr class='odd'>
		<td><a href="?op=historyGraph&reportType=${model.reportType}&date=${model.date}&key=pigeonTimeError" data-status="pigeonTimeError" class="graph_link">[::show::]</a></td>
	...
	<tr class='even'>
		<td><a href="?op=historyGraph&reportType=${model.reportType}&date=${model.date}&key=networkTimeError" data-status="networkTimeError" class="graph_link">[::show::]</a></td>
	...
	<tr class='odd'>
		<td><a href="?op=historyGraph&reportType=${model.reportType}&date=${model.date}&key=blockTotal" data-status="blockTotal" class="graph_link">[::show::]</a></td>
		<td>存储消息块数量</td>
	...
	<tr class='even'>
		<td><a href="?op=historyGraph&reportType=${model.reportType}&date=${model.date}&key=blockLoss" data-status="blockLoss" class="graph_link">[::show::]</a></td>
		<td>存储消息块丢失数量</td>
	...
	<tr class='odd'>
		<td><a href="?op=historyGraph&reportType=${model.reportType}&date=${model.date}&key=blockTime" data-status="blockTime" class="graph_link">[::show::]</a></td>
		<td>存储消息块花费时间(分钟)</td>
	...
	<tr class='even'>
		<td><a href="?op=historyGraph&reportType=${model.reportType}&date=${model.date}&key=size" data-status="size" class="graph_link">[::show::]</a></td>
		<td>压缩前消息大小(GB)</td>
	...
	<tr class='odd'>
		<td><a href="?op=historyGraph&reportType=${model.reportType}&date=${model.date}&key=delayAvg" data-status="delayAvg" class="graph_link">[::show::]</a></td>
		<td>系统处理延迟(ms)</td>
