...
<div class="tabbable">
  <ul class="nav nav-tabs" style="background-color:#f5f5f5">
    ...
    <li><a href="#business" data-toggle="tab"><strong>业务告警</strong></a></li>
    <li><a href="#transaction" data-toggle="tab"><strong>响应时间告警</strong></a></li>
    <li><a href="#network" data-toggle="tab"><strong>网络告警</strong></a></li>
    <li><a href="#system" data-toggle="tab"><strong>系统告警</strong></a></li>
    <li><a href="#exception" data-toggle="tab"><strong>异常告警</strong></a></li>
    <li><a href="#thirdPartyException" data-toggle="tab"><strong>第三方告警</strong></a></li>
    <li><a href="#frontendException" data-toggle="tab"><strong>前端告警</strong></a></li>
  </ul>
