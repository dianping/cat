	...
	<div class="span12">
		 <div class="tabbable tabs-left " id="content"> <!-- Only required for left/right tabs -->
  			<ul class="nav nav-tabs well" style="margin-top:30px;">
   			 	...
   			 	<li class="text-right" id="businessAlertButton"><a href="?op=view&docName=businessAlert"><strong>业务告警</strong></a></li>
   			 	...
   			 	<li class="text-right" id="exceptionButton"><a href="?op=view&docName=exception"><strong>异常监控</strong></a></li>
  			...
  			<div class="tab-content">
  				...
  				<c:choose>
			    	...
			    	<c:when test="${payload.docName == 'businessAlert'}">
			    		<%@ include file="monitorRule.jsp"%>
			    	</c:when>
			    	...
			    	<c:when test="${payload.docName == 'exception'}">
			    		<%@ include file="exceptionDocument.jsp"%>
			    	</c:when>
