...
<table style="width:90%" class="table table-striped table-bordered table-condensed">
	...
	<tr>
		<td>域名</td>
		<td>项目组名称，<span class="text-error">必需</span></td>
	<tr>
		<td>Type</td>
		<td>Transaction类型，<span class="text-error">必需，</span>某一类transaction的组别</td>
	</tr>
	<tr>
		<td>Name</td>
		<td>Transaction名称，<span class="text-error">非必需，</span>默认为All。当为All时，监控目标位为当前Type下所有transaction在一分钟内的平均响应时间；当为具体一个name时，监控某该transaction在一分钟内的平均响应时间。</td>
	</tr>
	<tr>
		<td>告警阈值</td>
...
<h5>B) 配置告警规则</h5>
<p>（1）告警名自定义，方便区分告警项。可对<span class="text-error">响应时间</span>进行监控。</p>
