...
<div class="row-fluid" style="margin-top:2px;">
	<div class="span8 text-center">
		<a id="navlineChart" class="btn  btn-sm btn-primary" href="?minute=${model.minute}&domain=${model.domain}&date=${model.date}">实时趋势图</a>
		<a id="navdependencyGraph" class="btn btn-sm btn-primary" href="?op=dependencyGraph&minute=${model.minute}&domain=${model.domain}&date=${model.date}">实时拓扑图</a>
		<a id="navmetricDashboard" class="btn btn-sm btn-primary" href="?op=metricDashboard&minute=${model.minute}&domain=${model.domain}&date=${model.date}">系统报错大盘</a>
		<a id="navdashboard" class="btn btn-sm btn-primary" href="?op=dashboard&minute=${model.minute}&domain=${model.domain}&date=${model.date}">应用监控盘</a>
		...
		<a id="navbussiness" class="btn btn-sm btn-primary" href="/cat/r/network?op=dashboard&domain=${model.domain}&date=${model.date}">网络监控大盘</a>
	</div>
