...
<div class="row-fluid" style="margin-top:2px;">
	...
	<div class="span4 text-center">
		<div class='text-center'>
			<a id="refresh10" class='btn btn-small btn-primary' href="?op=${payload.action.name}&fullScreen=${payload.fullScreen}&refresh=true&frequency=10&hideNav=${payload.hideNav}&domain=${model.domain}">10秒</a>
			<a id="refresh20" class='btn btn-small btn-primary' href="?op=${payload.action.name}&fullScreen=${payload.fullScreen}&refresh=true&frequency=20&hideNav=${payload.hideNav}&domain=${model.domain}">20秒</a>
			<a id="refresh30" class='btn btn-small btn-primary' href="?op=${payload.action.name}&fullScreen=${payload.fullScreen}&refresh=true&frequency=30&hideNav=${payload.hideNav}&domain=${model.domain}">30秒</a>
			<a id="fullScreen"  class='btn btn-small btn-primary' href="?op=${payload.action.name}&fullScreen=${!payload.fullScreen}&refresh=${payload.refresh}&hideNav=${payload.hideNav}&frequency=${payload.frequency}&domain=${model.domain}">全屏</a>
		</div>
	</div>
</div>
