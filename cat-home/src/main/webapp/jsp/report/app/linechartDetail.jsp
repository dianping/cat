	...
	<tr>
		<th>
			...
			<div class="input-group" style="float:left;width:60px">
				...
				<input type="text" id="endTime" style="width:60px;height: 34px"/>
			</div>
			<div class="input-group" style="float:left;width:130px">
			...
			<div class="input-group" style="float:left;width:110px">
				...
				<select id="operator" style="width: 110px;">
					<option value=''>All</option>
	...
	<tr>
		<th align=left>
			...
			<div class="input-group" style="float:left;width:120px">
				...
				<select id="appId" style="width: 126px;">
			...
			<div class="input-group" style="float:left;width:135px">
				...
				<select id="version" style="width: 135px;">
					<option value=''>All</option>
	...
	<tr>
		<th align=left>
			<div class="input-group" style="float:left;width:130px">
				...
				<select id="connectionType" style="width: 130px;">
					<option value=''>All</option>
			...
			<div class="input-group" style="float:left;width:285px">
				<span class="input-group-addon">命令</span>
				<form id="wrap_search" style="margin-bottom:0px;">
						<span class="input-icon" style="width:285px;">
							<input type="text" placeholder="" style="height: 34px"
			...
			<input class="btn btn-primary btn-sm" style="margin: 7px 7px;height: 34px"
				   ...
				   type="submit"/>
			<input class="btn btn-primary btn-sm" id="checkbox"
				   onclick="check()" type="checkbox"/>
			<label for="checkbox"
				   style="display: -webkit-inline-box;margin-top: 3px">选择对比</label>
		</th>
	</tr>
</table>
<table id="history" style="display: none;width:100%;margin-left: 3px">
	<tr>
		<th>
			<div class="input-group"  style="float:left;width:130px">
				<span class="input-group-addon">开始时间</span>
				<input type="text" id="time2" style="width:130px;height: 34px"/>
			</div>
			<div class="input-group" style="float:left;width:60px">
				<span class="input-group-addon">结束时间</span>
				<input type="text" id="endTime2" style="width:60px;height: 34px"/>
			</div>
			<div class="input-group" style="float:left;width:120px">
				<span class="input-group-addon">地区</span>
				<select id="city2" style="width: 130px;">
					<option value=''>All</option>
					<c:forEach var="item" items="${model.cities}" varStatus="status">
						<option value='${item.value.id}'>${item.value.value}</option>
					</c:forEach>
			...
			<div class="input-group" style="float:left;width:120px">
				<span class="input-group-addon">运营商</span>
				<select id="operator2" style="width: 110px;">
					<option value=''>All</option>
					<c:forEach var="item" items="${model.operators}"
							   varStatus="status">
						<option value='${item.value.id}'>${item.value.value}</option>
	...
	<tr>
		<th align=left>
			<div class="input-group" style="float:left;width:120px">
				<span class="input-group-addon">网络类型</span>
				<select id="network2" style="width:130px">
					<option value=''>All</option>
					<c:forEach var="item" items="${model.networks}" varStatus="status">
						<option value='${item.value.id}'>${item.value.value}</option>
					</c:forEach>
			...
			<div class="input-group" style="float:left;width:120px">
				<span class="input-group-addon">平台</span>
				<select id="platform2" style="width: 88px;">
					<option value=''>All</option>
					<c:forEach var="item" items="${model.platforms}"
							   varStatus="status">
						<option value='${item.value.id}'>${item.value.value}</option>
			...
			<div class="input-group" style="float:left;width:120px">
				<span class="input-group-addon">来源</span>
				<select id="source2" style="width: 130px;">
					<option value=''>All</option>
					<c:forEach var="item" items="${model.sources}"
							   varStatus="status">
						<option value='${item.value.id}'>${item.value.value}</option>
			...
			<div class="input-group" style="float:left;width:120px">
				<span class="input-group-addon">App</span>
				<select id="appId2" style="width: 126px;">
					<c:forEach var="item" items="${model.apps}" varStatus="status">
						<option value='${item.value.id}'>${item.value.value}</option>
					</c:forEach>
				</select>
			...
			<div class="input-group" style="float:left;width:120px">
				<span class="input-group-addon">版本</span>
				<select id="version2" style="width: 135px;">
					<option value=''>All</option>
					<c:forEach var="item" items="${model.versions}" varStatus="status">
						<option value='${item.value.id}'>${item.value.value}</option>
					</c:forEach>
	...
	<tr>
		<th align=left>
			<div class="input-group" style="float:left;width:120px">
				<span class="input-group-addon">连接类型</span>
				<select id="connectionType2" style="width: 130px;">
					<option value=''>All</option>
					<c:forEach var="item" items="${model.connectionTypes}"
							   varStatus="status">
						<option value='${item.value.id}'>${item.value.value}</option>
...
<div style="margin-top: 5px;margin-left: 10px">
	...
	<label class="btn btn-success btn-sm">
		<input type="radio" name="typeCheckbox" value="success">网络成功率
	</label>
	<label class="btn btn-success btn-sm">
		<input type="radio" name="typeCheckbox" value="businessSuccess">业务成功率
	</label>
	<label class="btn btn-success btn-sm">
		<input type="radio" name="typeCheckbox" value="delay">成功延时
	</label>
</div>
