	...
	<tr>
		<th align="left">
			...
			<div class="input-group" style="float:left;width:80px">
				...
				<input type="text" id="time2" style="width:80px;height: 34px;"/>
			</div>
	...
	<tr>
		<th align=left>
			...
			<div class="input-group" style="float:left;width:120px">
				...
				<select id="platform" style="width: 108px;">
					<option value=''>All</option>
			...
			<div class="input-group" style="float:left;width:120px">
				...
				<select id="appId" style="width: 116px;">
			...
			<div class="input-group" style="float:left;width:120px">
				...
				<select id="app-version" style="width: 114px;">
					<option value=''>All</option>
	...
	<tr>
		<th align=left>
			<div class="input-group" style="float:left;width:120px">
				...
				<select id="connect-type" style="width: 130px;">
					<option value=''>All</option>
			...
			<div class="input-group" style="float:left;width:120px">
				<span class="input-group-addon">饼图</span>
				<select id="piechartSelect" style="width: 108px;">
			...
			<div class="input-group" style="float:left;width:300px;">
				...
				<form id="wrap_search" style="margin-bottom:0px;">
						<span class="input-icon" style="width:310px;">
...
<c:choose>
	<c:when
		test="${(payload.groupByField.name eq 'network') or (payload.groupByField.name eq 'connect-type') or (payload.groupByField.name eq 'platform') or (payload.groupByField.name eq 'operator')}">
		<table>
			<tr>
				<td width="40%">
					<div>
