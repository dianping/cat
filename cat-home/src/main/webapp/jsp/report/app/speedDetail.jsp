	...
	<tr>
		<th align=left>
			...
			<div class="input-group" style="float:left;width:110px;">
				...
				<select id="network" style="width: 110px;">
					<option value=''>All</option>
	...
	<tr>
		<th align=left>
			...
			<div class="input-group" style="float:left;width:200px;">
				...
				<select id="page" style="width: 224px;height: 34px;">
			...
			<div class="input-group" style="float:left;width:200px;">
				...
				<select id="step" style="width: 224px;">
				</select>
			</div>
			...
			<label for="checkbox" style="display: -webkit-inline-box;margin-left: 7px;">
				选择对比</label>
		</th>
	</tr>
</table>
<table id="history" style="display: none;margin-left: 5px;">
	<tr>
		<th align=left>
			<div class="input-group" style="float:left;width:110px;">
				<span class="input-group-addon">日期</span>
				<input type="text" id="time2" style="width:110px;height:34px"/>
			</div>
			<div class="input-group" style="float:left;width:110px;">
				<span class="input-group-addon">地区</span>
			...
			<div class="input-group" style="float:left;width:110px;">
				<span class="input-group-addon">网络类型</span>
				<select id="network2" style="width: 110px;">
					<option value=''>All</option>
					<c:forEach var="item" items="${model.networks}" varStatus="status">
						<option value='${item.value.id}'>${item.value.value}</option>
					</c:forEach>
	...
	<tr>
		<th align=left>
			<div class="input-group" style="float:left;width:110px;">
				<span class="input-group-addon">平台</span>
				<select id="platform2" style="width: 110px;">
					<option value=''>All</option>
					<c:forEach var="item" items="${model.platforms}"
							   varStatus="status">
						<option value='${item.value.id}'>${item.value.value}</option>
			...
			<div class="input-group" style="float:left;width:110px;">
				<span class="input-group-addon">页面</span>
				<select id="page2" style="width: 224px;">
					<c:forEach var="item" items="${model.appSpeedDisplayInfo.pages}" varStatus="status">
						<option value='${item}'>${item}</option>
					</c:forEach>
				</select>
			...
			<div class="input-group" style="float:left;width:110px;">
				<span class="input-group-addon">阶段</span>
				<select id="step2" style="width: 224px;">
				</select>
			</div>
		</th>
	</tr>
