		...
		<tr>
			<th align=left>
				...
				<div class="input-group" style="float:left;width: 110px;">
					...
					<select id="city" style="width: 100px;height: 34px">
				...
				<div class="input-group" style="float:left;width:110px;">
					...
					<select id="operator" style="width: 100px;height: 34px">
						<option value=''>All</option>
				...
				<div class="input-group" style="float:left;width: 80px;">
					...
					<select id="network" style="width: 80px;height: 34px">
						<option value=''>All</option>
		...
		<tr>
			<th align=left>
				<div class="input-group" style="float:left;width: 110px;">
					...
					<select id="platform" style="width: 158px;height: 34px">
						<option value=''>All</option>
				...
				<div class="input-group" style="float:left;width: 110px;">
					...
					<select id="version" style="width: 88px;height: 34px">
						<option value=''>All</option>
				...
				<div class="input-group" style="float:left;width: 200px;">
					...
					<select id="page" style="width: 195px;height: 34px">
				...
				<div class="input-group" style="float:left;width: 200px;">
					...
					<select id="step" style="width: 195px;height: 34px">
					</select>
				</div>
