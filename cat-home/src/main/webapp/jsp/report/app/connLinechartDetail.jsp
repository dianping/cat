	...
	<tr>
		<th align=left>
			<div class="input-group" style="float:left;width:120px">
				...
				<select id="connectionType" style="width: 82px;">
					<option value=''>All</option>
			...
			<div class="input-group" style="float:left;width:120px">
				...
				<select id="version" style="width: 114px;">
					<option value=''>All</option>
			...
			<div class="input-group" style="float:left;width:255px">
				<span class="input-group-addon">命令</span>
				<form id="wrap_search" style="margin-bottom:0px;">
						<span class="input-icon" style="width:255px;">
			...
			<input class="btn btn-primary btn-sm" style="margin: 7px 7px;height: 34px"
				   ...
				   type="submit"/>
			<input class="btn btn-primary btn-sm" id="checkbox" onclick="check()" type="checkbox"/>
			<label for="checkbox" style="display: -webkit-inline-box;margin-left: 7px">选择对比</label>
		</th>
	</tr>
</table>
<table id="history" style="display: none;margin-left: 5px;">
	<tr>
		<th>
			<div class="input-group" style="float:left;width:120px">
				<span class="input-group-addon">日期</span>
	...
	<tr>
		<th align=left>
			<div class="input-group" style="float:left;width:120px">
				<span class="input-group-addon">连接类型</span>
				<select id="connectionType2" style="width: 82px;">
					<option value=''>All</option>
					<c:forEach var="item" items="${model.cipConnectionTypes}"
							   varStatus="status">
						<option value='${item.value.id}'>${item.value.value}</option>
			...
			<div class="input-group" style="float:left;width:120px">
				<span class="input-group-addon">平台</span>
				<select id="platform2" style="width: 130px;">
					<option value=''>All</option>
					<c:forEach var="item" items="${model.platforms}"
							   varStatus="status">
						<option value='${item.value.id}'>${item.value.value}</option>
			...
			<div class="input-group" style="float:left;width:120px">
				<span class="input-group-addon">版本</span>
				<select id="version2" style="width: 114px;">
					<option value=''>All</option>
					<c:forEach var="item" items="${model.versions}" varStatus="status">
						<option value='${item.value.id}'>${item.value.value}</option>
					</c:forEach>
...
<div style="margin: 7px 5px">&nbsp;
	...
	<label class="btn btn-info btn-sm">
		<input type="radio" name="typeCheckbox" value="success">成功率
	</label>
	<label class="btn btn-info btn-sm">
...
<table id="comparison_content" class="table table-striped table-condensed table-bordered table-hover" style="margin-left: 5px;">
	<thead>
	<tr>
