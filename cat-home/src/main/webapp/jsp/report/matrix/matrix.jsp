...
<jsp:useBean id="ctx" type="com.dianping.cat.matrix.Context"	scope="request" />
<jsp:useBean id="payload"	type="com.dianping.cat.matrix.Payload" scope="request" />
<jsp:useBean id="model" type="com.dianping.cat.matrix.Model"	scope="request" />
