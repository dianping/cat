...
<a:web_body>
		...
		<tr>
			<th align=left>
				...
				<div class="input-group" style="float:left;width:60px">
					...
					<input type="text" id="time2" style="width:60px;height:34px"/></div>
		...
		<tr>
			<th align=left>
				...
				<div class="input-group" style="float:left;width: 100px;">
					...
					<select id="step" style="width: 100px;"></select>
				</div>
				<div class="input-group" style="float:left;width: 90px;">
					<span class="input-group-addon">来源</span><select id="source" style="width: 90px;">
					<option value=''>All</option>
	...
	<table width="100%">
		...
		<tr>
			...
			<td>
				<div id="sourceChart" style="width:40%; height: 400px"></div>
			</td>
		</tr>
		<tr>
			<td>
