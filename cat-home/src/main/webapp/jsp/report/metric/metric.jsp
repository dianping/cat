          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
	             ...
	             <c:forEach var="item" items="${model.metricGroups}" varStatus="status">
		              <li class='nav-header' id="${item}"><a href="?op=dashboard&group=${item}&timeRange=${payload.timeRange}&date=${model.date}&domain=${model.domain}"><strong>${item.title}</strong></a></li>
	             </c:forEach>
