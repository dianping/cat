...
<table  class="table table-hover table-striped table-condensed" width="100%">
	<tr>
		...
		<td width="15%" class="right"><a href="?op=history&domain=${model.domain}&ip=${model.ipAddress}&date=${model.date}&sort=size&show=true">压缩前消息大小(GB)</a></td>
		...
		<td width="8%"  class="right"><a href="?op=history&domain=${model.domain}&ip=${model.ipAddress}&date=${model.date}&sort=machine&show=true">机器总数</a></td>
		<td>项目对应机器列表</td>
	</tr>
