...
<table class="machines">
    ...
    <c:choose>
		...
		<tr>
			...
			<th class="right"><a href="?domain=${model.domain}&date=${model.date}&ip=${model.ipAddress}&sort=missed">未命中</a></th>
			<th class="right"><a href="?domain=${model.domain}&date=${model.date}&ip=${model.ipAddress}&sort=hitPercent">命中率(%)</a></th>
			<th class="right"><a href="?domain=${model.domain}&date=${model.date}&sort=avg">平均耗时</a>(ms)</th>
		...
		<table class='table table-hover table-striped table-condensed'>
			...
			<th class="right"><a href="?domain=${model.domain}&date=${model.date}&ip=${model.ipAddress}&type=${payload.type}&sort=total&queryname=${model.queryName}">总量</a></th>
			...
			<th class="right"><a href="?domain=${model.domain}&date=${model.date}&ip=${model.ipAddress}&type=${payload.type}&sort=missed&queryname=${model.queryName}">未命中</a></th>
			<th class="right"><a href="?domain=${model.domain}&date=${model.date}&ip=${model.ipAddress}&type=${payload.type}&sort=hitPercent&queryname=${model.queryName}">命中率(%)</a></th>
			<th class="right"><a href="?domain=${model.domain}&date=${model.date}&type=${payload.type}&sort=avg&queryname=${model.queryName}">平均耗时</a>(ms)</th>
			<th class="right">QPS</th>
							</tr>
