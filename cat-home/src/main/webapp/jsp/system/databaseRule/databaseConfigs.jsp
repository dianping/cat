		...
		<div class="span10">
			...
			<table class="table table-striped table-condensed   table-hover">
	     		<tr class="text-success">
	     			...
	     			<th width="10%"><h5 class='text-center'>操作 <a href="?op=databaseRuleUpdate&key=${item.id}" class="btn update btn-primary btn-sm btn-primary">新增</a></h5></th>
	     		</tr>
		     	<c:forEach var="item" items="${model.ruleItems}" varStatus="status">
		     		...
		     		<td style="text-align:center;white-space: nowrap">
		     			<a href="?op=databaseRuleUpdate&key=${item.id}" class="btn update btn-primary btn-sm">修改</a>
			     		<a href="?op=databaseRulDelete&key=${item.id}" class="btn btn-primary btn-sm btn-danger delete">删除</a>
			     	</td>
		     		</tr>
		     	</c:forEach>
	     	</table>
