...
<a:body>
	...
	<table class="table table-striped table-bordered table-condensed">
		...
		<tr><td>页面URL</td><td><input name="page" value="${model.speed.page}" id="page" />&nbsp;&nbsp;<span class="text-error">*</span></td><td>支持数字、字符，例如：index.bin<br/></td></tr>
		</c:when>
		<c:otherwise>
		<tr>
		...
		<tr>
		<td>加载阶段</td><td><input name="step" value="${model.speed.step}" id="step" />&nbsp;&nbsp;<span class="text-error">*</span></td><td>仅支持数字，表明属于页面加载的第几阶段，例如：1<br/>
		</td>
		<tr>
		<td>加载说明</td><td><input name="title" value="${model.speed.title}" id="title" /></td><td>支持数字、字符，例如：index.bin加载第一阶段<br/></td>
		</tr>
		<tr>
		<td>延时阈值</td><td><input name="threshold" value="${model.speed.threshold}" id="threshold" />&nbsp;&nbsp;<span class="text-error">*</span></td><td>仅支持数字，单位毫秒，例如：100<br/></td>
		</tr>
		<tr>
