...
<div class="well sidebar-nav" >
         <ul class="nav nav-list">
	       ...
	       <li class="text-left" id="webRuleConfigList"><a href="?op=webRuleConfigList">WEB告警配置</a></li>
	       <li class="text-left" id="appRuleConfigList"><a href="?op=appRuleConfigList">APP告警配置</a></li>
	       ...
	       <li class="text-left" id="metricGroupConfigUpdate"><a href="?op=metricGroupConfigUpdate">业务指标分组</a></li>
           <li class='nav-header'>应用监控配置</li>
	       <li class="text-left" id="topylogyNodeConfigList"><a href="?op=topologyGraphNodeConfigList">拓扑节点阀值</a></li>
	       ...
	       <li class="text-left" id="bugConfigUpdate"><a href="?op=bugConfigUpdate">异常归属配置</a></li>
         </ul>
</div>
