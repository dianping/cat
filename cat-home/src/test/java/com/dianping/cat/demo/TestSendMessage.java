...
public class TestSendMessage {
	...
	public void sendException() throws Exception {
		for (int i = 0; i < 10; i++) {
			...
			try {
				...
				DefaultMessageTree tree = (DefaultMessageTree) Cat.getMessageTree();
	...
	public void sendSendCallErrorMessage() throws Exception {
		for (int i = 0; i < 100; i++) {
			Transaction t = Cat.newTransaction("Call", "Test");
	...
	public void sendSendSqlErrorMessage() throws Exception {
		for (int i = 0; i < 100; i++) {
			Transaction t = Cat.newTransaction("SQL", "Test");
	...
	public void sendError() throws Exception {
		for (int i = 0; i < 100; i++) {
			...
			Cat.logError(new OutOfMemoryError());
		}
		Thread.sleep(1000);
	}
	...
	public void sendEvent() throws Exception {
		for (int i = 0; i < 100; i++) {
			Event t = Cat.newEvent("Test", "Test");
	...
	public void sentHackPigenTransaction() throws Exception {
		for (int i = 0; i < 200; i++) {
			Transaction t = Cat.newTransaction("PigeonCall", "Method3");
			Cat.newEvent("PigeonCall.server", "192.168.7.24:8080");
			Cat.logEvent("RemoteCall", "Pigeon", Message.SUCCESS, "MessageID");
			t.addData("key and value");

			Thread.sleep(1);
			Cat.getMessageTree().setDomain("Pigeon");
			Cat.getMessageTree().setMessageId("Cat-c0a81a38-374214-1203");
			t.complete();
		}
	}
	...
	public void sendPigeonClientTransaction() throws Exception {
		for (int i = 0; i < 100; i++) {
			Transaction t = Cat.newTransaction("PigeonCall", "Method3");
			Cat.newEvent("PigeonCall.server", "192.168.64." + i + ":2280");
			t.addData("key and value");
		...
		for (int i = 0; i < 100; i++) {
			Transaction t = Cat.newTransaction("PigeonCall", "Method3");
			Cat.newEvent("PigeonCall.server", "192.168.64.11:2280");
			t.addData("key and value");
		...
		for (int i = 0; i < 200; i++) {
			Transaction t = Cat.newTransaction("PigeonCall", "Method3");
			Cat.newEvent("PigeonCall.server", "192.168.7.24:8080");
			Cat.logEvent("RemoteCall", "Test", Message.SUCCESS, "MessageID");
			t.addData("key and value");
		...
		for (int i = 0; i < 300; i++) {
			Transaction t = Cat.newTransaction("PigeonCall", "Method3");
			Cat.newEvent("PigeonCall.server", "192.168.7.39:8080");
			t.addData("key and value");
	...
	public void sendPigeonServerTransaction() throws Exception {
		for (int i = 0; i < 100; i++) {
			Transaction t = Cat.newTransaction("PigeonService", "Method6");
			Cat.newEvent("PigeonService.client", "192.168.7.77");
			t.addData("key and value");
		...
		for (int i = 0; i < 200; i++) {
			Transaction t = Cat.newTransaction("PigeonService", "Method8");
			Cat.newEvent("PigeonService.client", "192.168.7.20");
			t.addData("key and value");
		...
		for (int i = 0; i < 300; i++) {
			Transaction t = Cat.newTransaction("PigeonService", "Method5");
			Cat.newEvent("PigeonService.client", "192.168.7.231");
			t.addData("key and value");
	...
	public void sendCacheTransaction() throws Exception {
		for (int i = 0; i < 100; i++) {
			Transaction t = Cat.newTransaction("Cache.kvdb", "Method6");
			Cat.newEvent("PigeonService.client", "192.168.7.77");
			t.addData("key and value");

			Thread.sleep(11);
			Transaction t2 = Cat.newTransaction("Cache.local", "Method");
			Cat.newEvent("PigeonService.client", "192.168.7.77");
	...
	public void sendLongURLTransaction() throws Exception {
		for (int i = 0; i < 10; i++) {
			Transaction t = Cat.newTransaction("URL", "Method6");
			t.addData("key and value");
			Thread.sleep(60);
			t.complete();
		}
	...
	public void sendLongSQLTransaction() throws Exception {
		for (int i = 0; i < 10; i++) {
			Transaction t = Cat.newTransaction("SQL", "Method6");
			t.addData("key and value");
			Thread.sleep(102);
			t.complete();
		}
	...
	public void sendCacheTransactionWithMissed() throws Exception {
		...
		Transaction t2 = Cat.newTransaction("Cache.web", "Method");
		t2.addData("key and value");
		Thread.sleep(2);
		t2.complete();
		Thread.sleep(1000);
	...
	public void sendSqlTransaction() throws Exception {
		for (int k = 0; k < 5; k++) {
			for (int i = 0; i < 100; i++) {
				Transaction t = Cat.newTransaction("SQL", "User.select" + i % 10);
				Cat.newEvent("SQL.Method", "Select").setStatus(Message.SUCCESS);
				...
				Cat.newEvent("SQL.Method", "Update").setStatus(Message.SUCCESS);
				Cat.newEvent("SQL.Database", "jdbc:mysql://192.168.7.43:3306/database" + k)
										.setStatus(Message.SUCCESS);
				...
				Cat.newEvent("SQL.Method", "Delete").setStatus(Message.SUCCESS);
				Cat.newEvent("SQL.Database", "jdbc:mysql://192.168.7.43:3306/database" + k)
										.setStatus(Message.SUCCESS);
	...
	public void sendOtherDomainSqlTransaction() throws Exception {
		for (int k = 0; k < 5; k++) {
			for (int i = 0; i < 100; i++) {
				...
				t.addData("select * from hostinfo");
				t.setStatus(Message.SUCCESS);
				Cat.getMessageTree().setDomain("CatDemo");
				t.complete();
	...
	public void sendDependencyTransaction() throws Exception {
		...
		for (int i = 0; i < size; i++) {
			Transaction t = Cat.newTransaction("SQL", "User.select" + i % 10);
			Cat.newEvent("SQL.Method", "Select").setStatus(Message.SUCCESS);
			Cat.newEvent("SQL.Database", "jdbc:mysql://192.168.7.43:3306/database" + i % 4)
									.setStatus(Message.SUCCESS);
			t.addData("select * from hostinfo");
			t.setStatus(Message.SUCCESS);
			t.complete();
