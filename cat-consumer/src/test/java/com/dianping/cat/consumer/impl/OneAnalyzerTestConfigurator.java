...
import com.dianping.cat.consumer.impl.OneAnalyzerTest.MockAnalyzer;
...
public class OneAnalyzerTestConfigurator extends
		AbstractResourceConfigurator {
	public static void main(String[] args) {
		generatePlexusComponentsXmlFile(new OneAnalyzerTestConfigurator());
	}
	...
	protected File getConfigurationFile() {
		return new File("src/test/resources/"
				+ OneAnalyzerTest.class.getName().replace('.', '/')
				+ ".xml");
	}
}
